...
pub const KVM_XEN_ATTR_TYPE_VCPU_INFO: u32 = 2;
pub const KVM_XEN_ATTR_TYPE_VCPU_TIME_INFO: u32 = 3;
pub const KVM_XEN_ATTR_TYPE_VCPU_RUNSTATE: u32 = 4;
pub const KVM_XEN_ATTR_TYPE_UPCALL_VECTOR: u32 = 5;
...
impl ::std::cmp::PartialEq for kvm_lapic_state {
    fn eq(&self, other: &kvm_lapic_state) -> bool {
...
impl ::std::fmt::Debug for kvm_xsave {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_xsave {{ region: [{}] }}",
...
impl ::std::cmp::PartialEq for kvm_xsave {
    fn eq(&self, other: &kvm_xsave) -> bool {
...
impl ::std::fmt::Debug for kvm_vmx_nested_state_data {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_vmx_nested_state_data {{ vmcs12: [{}], shadow_vmcs12: [{}] }}",
            self.vmcs12
                .iter()
                .enumerate()
                .map(|(i, v)| format!("{}{:?}", if i > 0 { ", " } else { "" }, v))
...
impl ::std::cmp::PartialEq for kvm_vmx_nested_state_data {
    fn eq(&self, other: &kvm_vmx_nested_state_data) -> bool {
        &self.vmcs12[..] == &other.vmcs12[..] && &self.shadow_vmcs12[..] == &other.shadow_vmcs12[..]
    }
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
...
impl ::std::fmt::Debug for kvm_ioeventfd {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! (f , "kvm_ioeventfd {{ datamatch: {:?}, addr: {:?}, len: {:?}, fd: {:?}, flags: {:?}, pad: [{}] }}" , self . datamatch , self . addr , self . len , self . fd , self . flags , self . pad . iter () . enumerate () . map (| (i , v) | format ! ("{}{:?}" , if i > 0 { ", " } else { "" } , v)) . collect :: < String > ())
    }
}
impl ::std::cmp::PartialEq for kvm_ioeventfd {
    fn eq(&self, other: &kvm_ioeventfd) -> bool {
...
impl ::std::fmt::Debug for kvm_enable_cap {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_enable_cap {{ cap: {:?}, flags: {:?}, args: {:?}, pad: [{}] }}",
            self.cap,
            self.flags,
            self.args,
            self.pad
...
impl ::std::cmp::PartialEq for kvm_enable_cap {
    fn eq(&self, other: &kvm_enable_cap) -> bool {
        self.cap == other.cap
            && self.flags == other.flags
...
impl ::std::fmt::Debug for kvm_ppc_pvinfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_ppc_pvinfo {{ flags: {:?}, hcall: {:?}, pad: [{}] }}",
            self.flags,
            self.hcall,
            self.pad
                .iter()
...
impl ::std::cmp::PartialEq for kvm_ppc_pvinfo {
    fn eq(&self, other: &kvm_ppc_pvinfo) -> bool {
        self.flags == other.flags && self.hcall == other.hcall && &self.pad[..] == &other.pad[..]
    }
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
...
pub union kvm_xen_hvm_attr__bindgen_ty_1 {
    ...
    pub vcpu_attr: kvm_xen_hvm_attr__bindgen_ty_1__bindgen_ty_2,
...
fn bindgen_test_layout_kvm_xen_hvm_attr__bindgen_ty_1__bindgen_ty_2() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_xen_hvm_attr__bindgen_ty_1__bindgen_ty_2>())).vcpu_id
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_xen_hvm_attr__bindgen_ty_1__bindgen_ty_2>())).gpa as *const _
                as usize
        },
        8usize,
        concat!(
...
fn bindgen_test_layout_kvm_xen_hvm_attr__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<kvm_xen_hvm_attr__bindgen_ty_1>())).vcpu_attr as *const _
                as usize
        },
        0usize,
        concat!(
